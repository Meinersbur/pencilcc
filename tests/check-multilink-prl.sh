...
${PENCILCC} -c -vv -O3 --target=prl -Werror "${TESTSRCDIR}/multilink_kernel1.pencil.c" -o multilink_kernel1.o
${PENCILCC} -c -vv -O3 --target=prl -Werror "${TESTSRCDIR}/multilink_kernel2.pencil.c" -o multilink_kernel2.o
