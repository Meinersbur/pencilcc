...
# _AX_SUBMODULE_FWD(name, , system|build|bundled, default)
AC_DEFUN([_AX_SUBMODULE_FWD],
[
...
# AX_SUBMODULE_FWD(name, system|build|bundled, default)
AC_DEFUN([AX_SUBMODULE_FWD], [
	_AX_SUBMODULE_FWD($1, m4_bpatsubst([$1],
